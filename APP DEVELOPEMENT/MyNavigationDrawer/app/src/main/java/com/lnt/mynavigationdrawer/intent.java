 ...
 * Use the {@link Intent# factory method to
...
public class intent extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final EditText editText= getView().findViewById(R.id.textView2);
        Button btn=(Button)getView().findViewById(R.id.btnNavigate);
